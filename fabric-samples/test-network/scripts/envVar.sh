...
setGlobalsWithAdminKeys() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    if [ $USING_PEER -eq 0 ]; then
      ...
      export CORE_PEER_ADDRESS=localhost:10055
    fi
    ...
    if [ $USING_PEER -eq 0 ]; then
      ...
      export CORE_PEER_ADDRESS=localhost:10057
    fi
...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    if [ $USING_PEER -eq 0 ]; then
      ...
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/msp
      export CORE_PEER_ADDRESS=localhost:8055
    elif [ $USING_PEER -eq 2 ]; then
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org3.example.com/peers/peer2.org2.example.com/msp
      export CORE_PEER_ADDRESS=localhost:9055
    elif [ $USING_PEER -eq 3 ]; then
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org3.example.com/peers/peer3.org3.example.com/msp
      export CORE_PEER_ADDRESS=localhost:10055
    fi
  elif [ $USING_ORG -eq 4 ]; then
    export CORE_PEER_LOCALMSPID="Org4MSP"
    ...
    if [ $USING_PEER -eq 0 ]; then
      ...
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/msp
      export CORE_PEER_ADDRESS=localhost:8057
    elif [ $USING_PEER -eq 2 ]; then
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/msp
      export CORE_PEER_ADDRESS=localhost:9057
    elif [ $USING_PEER -eq 3 ]; then
      export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer3.org4.example.com/msp
      export CORE_PEER_ADDRESS=localhost:10057
    fi
...
setGlobalsCLI() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_ADDRESS=peer0.org2.example.com:7053
  elif [ $USING_ORG -eq 3 ]; then
    export CORE_PEER_ADDRESS=peer0.org3.example.com:7055
  elif [ $USING_ORG -eq 4 ]; then
    export CORE_PEER_ADDRESS=peer0.org4.example.com:7057
  elif [ $USING_ORG -eq 5 ]; then
    export CORE_PEER_ADDRESS=peer0.org5.example.com:7059
  else
    errorln "ORG Unknown"
  fi
}
